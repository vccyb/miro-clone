<template>
  <div
    class="absolute left-2 top-1/2 -translate-y-1/2 bg-white rounded-md p-1.5 flex flex-col gap-2 shadow-md"
  >
    <toolbarButton
      label="选择工具"
...
const disabledUndo = computed(() => {
  return !canvasStore.canUndo
})
const disabledRedo = computed(() => {
  return !canvasStore.canRedo
})
